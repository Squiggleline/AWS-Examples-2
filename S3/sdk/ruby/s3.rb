...
require 'pry'        # Interacting shell for debugging
...
# Determine the number of files to name and upload
...
number_of_files.times.each do |i|
    ...
    output_path = "/tmp/#{filename}"  # Specifying the output path for each file
    ...
    File.open(output_path, 'rb') do |f|  # 'rb' mode for reading binary
